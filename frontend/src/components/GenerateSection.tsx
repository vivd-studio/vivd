    ...
    trpc.project.generate.useMutation({
      ...
      onSuccess: (data) => {
        if (data.status === "exists") {
          // Store version info from the response
          // Cast to access properties only available on 'exists' status response
          ...
          // Cast to access version property on processing response
            ...
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              <div className="flex gap-2 items-start">
                ...
                <Button
                  ...
                  className="shadow-md transition-all hover:scale-105 active:scale-95 bg-indigo-600 hover:bg-indigo-700 text-white"
                >
