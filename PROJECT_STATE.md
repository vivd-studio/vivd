...
- 2026-04-17: Slowed and softened the shared shell sidebar motion so the standard slide-in/out and immersive peek appear/disappear less abruptly. Validation: `npm run test:run -w @vivd/frontend -- src/components/ui/sidebar.test.tsx` passes.
