...
run_release_preflight() {
  ...
  run_step \
    ...
    npm run test:run --workspace=@vivd/backend -- studio_api_router.test.ts trpc_context_org_procedure.test.ts project_runtime_thumbnail_route.test.ts fly_lifecycle.test.ts fly_provider_reconcile.test.ts fly_provider_orchestration.test.ts
