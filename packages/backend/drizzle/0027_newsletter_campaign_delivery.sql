CREATE TABLE "newsletter_campaign_delivery" (
...
ALTER TABLE "newsletter_campaign" ADD COLUMN "recipient_count" integer DEFAULT 0 NOT NULL;
--> statement-breakpoint
ALTER TABLE "newsletter_campaign" ADD COLUMN "test_sent_at" timestamp;
--> statement-breakpoint
ALTER TABLE "newsletter_campaign" ADD COLUMN "queued_at" timestamp;
--> statement-breakpoint
ALTER TABLE "newsletter_campaign" ADD COLUMN "started_at" timestamp;
--> statement-breakpoint
ALTER TABLE "newsletter_campaign" ADD COLUMN "completed_at" timestamp;
--> statement-breakpoint
ALTER TABLE "newsletter_campaign" ADD COLUMN "canceled_at" timestamp;
--> statement-breakpoint
ALTER TABLE "newsletter_campaign" ADD COLUMN "last_error" text;
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX "newsletter_campaign_delivery_campaign_subscriber_unique" ON "newsletter_campaign_delivery" USING btree ("campaign_id","subscriber_id");
--> statement-breakpoint
CREATE INDEX "newsletter_campaign_delivery_campaign_status_idx" ON "newsletter_campaign_delivery" USING btree ("campaign_id","status","updated_at");
--> statement-breakpoint
CREATE INDEX "newsletter_campaign_delivery_plugin_status_created_idx" ON "newsletter_campaign_delivery" USING btree ("plugin_instance_id","status","created_at");
