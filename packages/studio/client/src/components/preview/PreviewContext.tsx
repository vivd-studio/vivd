...
export function PreviewProvider({
  ...
  const isCmsPreviewFieldUpdate = useCallback(
    (patch: SavePatch): patch is CmsPreviewFieldUpdate => patch.type === "setCmsField",
    [],
  );
  ...
  const isSaving =
    applyHtmlPatchesMutation.isPending || applyCmsPreviewFieldUpdatesMutation.isPending;
  ...
  const handleSave = useCallback(() => {
    ...
    void (async () => {
      ...
      try {
        ...
        const hasMissingElements = rawErrors.some((e) => e.reason === "Element not found");
