...
<Aside type="note" title="Self-host admin surface">
  This page is for the `solo` self-host path. Hosted Vivd workspaces are managed by the
  Vivd platform and do not require these install-wide settings.
</Aside>
