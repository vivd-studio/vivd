...
The main solo public host still acts as a publish target, and additional registered custom
publish domains can still be used without turning on tenant-host routing.
