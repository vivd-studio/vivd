...
const SIDEBAR_WIDTH_ICON = "var(--vivd-sidebar-collapsed-size, 3rem)";
...
function readPersistedSidebarOpen(defaultOpen: boolean) {
  ...
  try {
    ...
    // Ignore storage access failures and fall back to cookie/default.
  }
...
function persistSidebarOpen(open: boolean) {
  if (typeof window !== "undefined") {
    try {
      ...
      // Ignore storage access failures and keep UI functional.
    }
  }
    ...
    return (
      ...
      >
        ...
        <div
          data-sidebar="gap"
          className={cn(
            "relative bg-transparent transition-[width] duration-[240ms] ease-linear",
            isImmersiveDesktop
              ? open
                ? "w-[var(--sidebar-width)]"
                : "w-0"
        ...
        <div
          className={cn(
            ...
            isImmersiveDesktop
              ? [
                  "z-30 transition-[width,opacity,transform,visibility] duration-[420ms] ease-[cubic-bezier(0.22,1,0.36,1)]",
              ...
              : [
                  "z-10 w-[var(--sidebar-width)] transition-[left,right,width] duration-[240ms] ease-linear",
                  side === "left"
