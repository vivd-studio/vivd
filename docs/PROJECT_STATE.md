...
- 2026-02-13: auto-redirect authenticated control-plane navigation (`app.*`) to the user’s active org tenant host, and keep session active-org in sync when visiting tenant hosts.
